...
int main(){
    ...
    auto guiFunction = [&d3velop]() {
        ImGui::GetStyle() = ImGuiTheme::ThemeToStyle( ImGuiTheme::ImGuiTheme_DarculaDarker);
        d3velop.run();
     ...
     runParams.appWindowParams.windowGeometry.positionMode = HelloImGui::WindowPositionMode::MonitorCenter;
     runParams.imGuiWindowParams.defaultImGuiWindowType = HelloImGui::DefaultImGuiWindowType::ProvideFullScreenDockSpace;
    ...
    runParams.dockingParams.layoutCondition = HelloImGui::DockingLayoutCondition::ApplicationStart;

    auto fontFunction = [&d3velop]() {
        HelloImGui::FontLoadingParams fontParams;
        fontParams.insideAssets = false;
        //HelloImGui::LoadFontDpiResponsive("../assets/JetBrainsMono-Regular.ttf", 14.0f, fontParams);
        //HelloImGui::LoadFontDpiResponsive("../assets/Roboto-Regular.ttf", 14.0f, fontParams);
